...
\title[Pesquisa Operacional - Modelagem do Problema da Corrente de Equilíbrio]
{
  Pesquisa Operacional - Modelagem do Problema da Corrente de Equilíbrio
}
...
\section{Modelagem}
  ...
  \begin{frame}[t]{Modelagem da Indústria de Laticínio}
    \begin{figure}[h!]
      \centering
        %%\includegraphics[width=0.6\textwidth]{img/problema.png}
    \end{figure}
  \end{frame}
...
\section{Conclusões}
  ...
  \begin{frame}{Dúvidas}
    \begin{figure}[h!]
      \centering
        %%\includegraphics[width=0.5\textwidth]{img/queijo.jpg}
    \end{figure}
  \end{frame}
