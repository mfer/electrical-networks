...
\section{Modelagem}
  ...
  \subsection{O Modelo}
  \begin{frame}{Modelos}
    Existe mais de uma forma de se resolver o este problema. Duas dessas formas serão desenvolvidas aqui:
  ...
  \begin{frame}[t]{Modelagem como sistema quadrático}
    \begin{itemize}
      \item
...
\end{tikzpicture}
  ...
  \begin{frame}{Sistema quadrático}
    ...
    \begin{equation*}
      F:A \longrightarrow I \subset \mathbb{N}
    \end{equation*}
    ...
    \begin{equation*}
\textrm{Tal que }      (i_1, j_1) < (i_2, j_2) \longleftrightarrow F[(i_1, j_1)] < F[(i_2, j_2)]
    \end{equation*}

    \begin{equation*}
\textrm{Sendo que } (a,b) < (c,d) \longleftrightarrow (a < c)  || ((a == c) \&\& (b < d))
    \end{equation*}
Esta ordem faz com que F seja invertível
  \end{frame}
  ...
  \begin{frame}{Sistema quadrático}
    ...
    \begin{equation*}
      A_{i,j} = 0 \hspace {1.5cm} \textrm{Caso contrário}
    \end{equation*}
  ...
  \begin{frame}{Sistema quadrático}
    ...
    \begin{equation*}
      b_i = 0 \hspace {1.5cm} \textrm{Caso contrário}
    \end{equation*}
