...
Tal que
  ...
  \subsection{Minimização Quadrática - Octave}
  ...
  \subsection{Sistema Linear - Numerical Recipes}
  ...
  \subsection{netgen.c}
  \begin{frame}{net genenerator Klingman }
    \centering
    ...
    netgn151
		...
		\begin {tabular}{|c|c|}
		\hline
			método & tempo (s)\\ \hline
			nr & 900  \\ \hline
		  octave &  $\infty$ \\ \hline
		\end{tabular}
                %% \\
                %% \\
                %% Octave - arquivo de entrada excedeu um tamanho razoável.
		}
